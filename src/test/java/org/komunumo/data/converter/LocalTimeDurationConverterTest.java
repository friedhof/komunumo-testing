...
class LocalTimeDurationConverterTest {
    ...
    void to() {
        ...
        assertEquals(converter.from(LocalTime.of(0, 0)), Duration.ofMinutes(0));
        assertEquals(converter.from(LocalTime.of(0, 1)), Duration.ofMinutes(1));
        assertEquals(converter.from(LocalTime.of(1, 0)), Duration.ofMinutes(60));
        assertEquals(converter.from(LocalTime.of(1, 1)), Duration.ofMinutes(61));
        assertEquals(converter.from(LocalTime.of(1, 30)), Duration.ofMinutes(90));
    }
